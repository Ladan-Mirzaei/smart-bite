...
SELECT 
    ...
    ARRAY_AGG(DISTINCT "recipe_diet_type"."name") AS "diet_types",
    "recipe"."image" AS "image"
FROM "recipe"
LEFT JOIN "recipe_diet" 
    ON "recipe"."id" = "recipe_diet"."recipe_id"
LEFT JOIN "recipe_diet_type" 
    ON "recipe_diet"."diet_type_id" = "recipe_diet_type"."id"
LEFT JOIN "recipe_categories" 
    ON "recipe"."category_id" = "recipe_categories"."id"
LEFT JOIN "recipe_ingredient_details" 
    ON "recipe"."id" = "recipe_ingredient_details"."recipe_id"
LEFT JOIN "recipe_ingredient" 
    ON "recipe_ingredient"."id" = "recipe_ingredient_details"."ingredient_id"
GROUP BY 
    "recipe"."id", 
    "recipe"."title", 
    "recipe"."cooking_time", 
